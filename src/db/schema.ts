...
export const customers = pgTable("customers", {
  ...
  petHairRating: integer("pet_hair_rating"),
  dogCount: integer("dog_count"),
  catCount: integer("cat_count"),
  dogNames: text("dog_names"),
  catNames: text("cat_names"),
  homeDetails: jsonb("home_details").notNull().default({}),
  mopHeadCount: integer("mop_head_count"),
  ragCount: integer("rag_count"),
  vacuumCount: integer("vacuum_count"),
