  ...
  return (
    <section className="co-card overflow-hidden">
      ...
      <form onSubmit={submit} className="grid gap-3 p-4 sm:grid-cols-2 sm:p-5">
        ...
        <div className="flex items-center justify-between gap-3 sm:col-span-2"><p aria-live="polite" className="text-xs text-[var(--co-evergreen)]">{message}</p><button type="submit" disabled={saving || !startDate} className="co-button-primary shrink-0">{saving ? "Sending…" : "Send request"}</button></div>
      </form>
