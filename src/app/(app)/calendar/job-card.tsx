...
export default function JobCard({ job, employees, draggable = false, onDragStart, onOpen, onMoveAssign, variant = "timeline", ordinalLabel }: { job: CardJob; employees: Employee[]; draggable?: boolean; onDragStart?: (event: React.DragEvent<HTMLAnchorElement>) => void; onOpen?: (jobId: string) => void; onMoveAssign?: (jobId: string) => void; variant?: "timeline" | "list"; ordinalLabel?: string }) {
