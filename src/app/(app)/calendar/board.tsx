    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div ref={dialogRef} tabIndex={-1} role="dialog" aria-modal="true" aria-labelledby="assign-at-time-title" className="relative flex max-h-[min(760px,calc(100dvh-2rem))] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-[var(--co-line)] bg-[var(--co-surface)] shadow-[var(--co-shadow-panel)]">
        ...
        <div className="min-h-0 overflow-y-auto p-5">
          <div className="flex flex-wrap items-end gap-3"><TimeInput label="Arrival time" value={time} onChange={setTime} className="min-w-48" /><div className="flex gap-2"><button type="button" onClick={() => setTime("09:00")} className="co-button-secondary py-2 text-xs">Morning · 9 AM</button><button type="button" onClick={() => setTime("13:00")} className="co-button-secondary py-2 text-xs">Afternoon · 1 PM</button><button type="button" onClick={() => setTime("14:00")} className="co-button-secondary py-2 text-xs">Second house · 2 PM</button></div></div>
      ...
      <div ref={dialogRef} tabIndex={-1} role="dialog" aria-modal="true" aria-labelledby="rail-action-title" className="relative w-full max-w-md rounded-2xl border border-[var(--co-line)] bg-[var(--co-surface)] p-5 shadow-[var(--co-shadow-panel)]">
        ...
        {mode === "bump" ? (
          <div className="mt-5 space-y-4">
            <DateInput label="New date" value={date} onChange={setDate} />
