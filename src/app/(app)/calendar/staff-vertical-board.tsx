...
import { APPOINTMENT_COLOR, APPOINTMENT_COLOR_CANCELLED, displayCustomer, employeeCardStyle, employeeColor, formatAppointmentTime, jobWallClockDuration, minutesFromTime } from "./shared";
...
export default function StaffVerticalBoard({
  dayIso,
  todayIso,
  employees,
  jobs: initialJobs,
  ...
  return <>
    ...
    {editingAppointmentId ? <AppointmentPanel mode="edit" eventId={editingAppointmentId} staffRoster={staffRoster} defaultDate={appointments.find((appointment) => appointment.id === editingAppointmentId)?.scheduledDate ?? ""} onClose={() => setEditingAppointmentId(null)} /> : null}
  </>;
}
