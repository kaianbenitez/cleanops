...
function statusTone(row: EmployeeDirectoryRow) { if (!row.isActive) return "text-slate-500 dark:text-[var(--co-faint)]"; return row.status === "Scheduled" ? "text-amber-700 dark:text-[var(--co-warning)]" : "text-[var(--co-accent-text)]"; }
