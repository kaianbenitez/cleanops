...
export default async function QualityPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return <div className="max-w-7xl space-y-6">
    <header className="flex flex-wrap items-end justify-between gap-4">
      <div><div className="flex items-center gap-2 text-[var(--co-accent-text)]"><Star className="h-5 w-5" /><p className="eyebrow">Customer experience</p></div><h1 className="page-title mt-2">Quality</h1><p className="page-subtitle">Track every completed job and see who has responded.</p></div>
