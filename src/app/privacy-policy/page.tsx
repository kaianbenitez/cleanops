  ...
  return (
    <div className="max-w-3xl space-y-4">
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>We do not sell or rent this information. We share it only with the service providers that help us operate Shimmer, each of whom is only permitted to use it to provide their service to us:</p>
        <ul className="list-disc space-y-2 pl-5">
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>We retain information for as long as your company&apos;s Shimmer account is active, and afterward only as long as needed to meet legal, tax, payroll, or accounting obligations, resolve disputes, or enforce our agreements.</p>
      </section>
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>We may update this policy as Shimmer changes. We&apos;ll let company administrators know about material changes.</p>
      </section>
