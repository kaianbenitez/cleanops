  ...
  return (
    <div className="max-w-3xl space-y-4">
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>
          Shimmer is under active development and is subject to change. Features may be added, changed, or removed, and the way things look or work today may be different tomorrow. We&apos;ll do our best to avoid disrupting your work, but as a beta product, things may occasionally break or shift without much notice.
        </p>
      </section>
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>
          You own the customer, job, payroll, and other business data your company enters into Shimmer. We don&apos;t sell it or use it for anything other than operating the platform for you. You can request a full CSV export of your company&apos;s data at any time, and there&apos;s no lock-in — if you decide to stop using Shimmer, your data is yours to take with you.
        </p>
      </section>
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>
          During this beta period, Shimmer is provided &quot;as is,&quot; without warranty of any kind, express or implied. We work hard to keep it reliable, but we can&apos;t guarantee it will always be available, accurate, or error-free.
        </p>
      </section>
      ...
      <section className="co-card space-y-3 p-5 text-sm leading-6 text-[var(--co-muted)]">
        ...
        <p>
          We may update these terms as Shimmer changes. If we make a material change, we&apos;ll let company administrators know.
        </p>
      </section>
